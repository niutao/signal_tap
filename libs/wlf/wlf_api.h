...
/* $Id: //dvt/mti/rel/6.6d/src/tkgui/wlf_api.h#1 $ */
...
#define wlfSelSVInterface       0x0400000000000000LL
#define wlfSelImmediateAssert   0x2000000000000000LL
#define wlfSelAssertionScope    0x4000000000000000LL
...
#define wlfSelSVInterface       0x0400000000000000
#define wlfSelImmediateAssert   0x2000000000000000
#define wlfSelAssertionScope    0x4000000000000000
#endif
...
/* must use WlfSymbolSel64 */
#define wlfSelTrStreams         ( wlfSelTrStream |          \
                                  wlfSelTrStreamArray )
/* must use WlfSymbolSel64 */
